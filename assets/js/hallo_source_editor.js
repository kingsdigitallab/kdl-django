...
>\n            <button type="button" class="close text-replace" data-dismiss="modal" aria-hidden="true" class="button"><i class="icon icon-cross"></i></button>\n            <div class="modal-body"><hea\
der class="nice-padding hasform"><div class="row"><div class="left"><div class="col"><h1><i class="icon icon-code"></i>&nbsp;Edit HTML Code</h1></div></header><div class="modal-bo\
dy-body"></div></div>\n        </div><!-- /.modal-content -->\n    </div><!-- /.modal-dialog -->\n</div>');
...
d="wagtail-edit-html-save" type="button" style="margin: 0 4%; float: right;" class="button">Save</button>');
