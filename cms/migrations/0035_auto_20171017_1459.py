...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('cms', '0034_starred_page_featured_block_optional'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='cms.IdeaFormPage'),
        ),
    ]
